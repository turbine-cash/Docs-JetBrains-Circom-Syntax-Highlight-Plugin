...
1. **Check GitHub Issues**
   ...
   Visit the [plugin's GitHub repository](https://github.com/ZKLSOL/JetBrains-Circom-Syntax-Highlight-Plugin/issues) to see if your issue has been reported.

2. **Report a Bug**

   If you've found a new issue, please [open a GitHub issue](https://github.com/ZKLSOL/JetBrains-Circom-Syntax-Highlight-Plugin/issues/new) with:
   - Your IDE version
   - Plugin version
   - Steps to reproduce
   - Any error messages
